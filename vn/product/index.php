    ...
    <div class="usp-header-placeholder">
        <div class="callout-bars">
            <div class="callout-bar last slot-content-contain clearfix ">
                <img src="/img/adidas_USP_delivery.png" width="88" height="88" class="base lazyload" />
...
function changecursor() {
    document.getElementById("expandedImg").style.cursor = 'url(/glass/assets/img/icon-adidas-cursor-zoomed.png) 24 24,auto';
    document.getElementById("expandedImg").setAttribute("onclick", "restorecursor()");
}
function restorecursor() {
    document.getElementById("expandedImg").style.cursor = 'url(/glass/assets/img/icon-adidas-cursor-zoom.png) 24 24,auto';
...
<!------------------------------------------------------------------------------------------ --> 
    <div data-auto-id="color-chooser" class="gl-vspacing-l wrapper___2M6MI">
        ...
        <div class="gl-label gl-label--large gl-vspacing-s color_text___mgoYV"><?php if (!empty($COLORDT)) echo $COLORDT?>  
        </div>
...
<?php if(empty ($_SESSION["email"])) echo '<form action="/vn/login/" method="post">'?> 
<script>
...
<div class="col-s-12 offset-l-1 col-l-22 col-xl-20 offset-xl-2 offset-hg-3 col-hg-18" style=" margin-left: 10%;margin-top:-320px;margin-bottom:120px;">
                ...
                <div class="container row tab_container___3cvLR">
                    <div class="col-l-12 no-gutters">
                        ...
                        <ul class="no_bullets___3QQYt flex___28BXU">
                            <li class="gl-vspacing-m"><img src="/glass/assets/img/washing-instructions/A5.svg" width="24" height="24">Giặt nước ấm</li>
                            <li class="gl-vspacing-m"><img src="/glass/assets/img/washing-instructions/B1.svg" width="24" height="24">Không tẩy</li>
                            <li class="gl-vspacing-m"><img src="/glass/assets/img/washing-instructions/C2.svg" width="24" height="24">Phơi khô nơi thoáng mát</li>
                            <li class="gl-vspacing-m"><img src="/glass/assets/img/washing-instructions/D2.svg" width="24" height="24">Chạm vào bằng bàn ủi mát</li>
                            <li class="gl-vspacing-m"><img src="/glass/assets/img/washing-instructions/E1.svg" width="24" height="24">Không giặt khô</li>
                        </ul>
                    </div>
