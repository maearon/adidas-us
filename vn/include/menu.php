...
<div class="glass-header-top" <?php if(empty ($_SESSION["email"])) echo ''; else echo 'style="display: none"';?>>
  ...
  <div class="menu-spacer___3Gp4L"></div>
  <em><a href="/vn/register">Đăng ký mới<!-- --> </a></em>
  <a href="/vn/login/" href="">Đăng nhập<!-- --> 
  <span class="login-icon"></span></a>
</div>

<div class="glass-header-top" <?php if(empty ($_SESSION["email"])) echo ' style="display: none"';?>>
<a href="/vn/login/login_success.php">tài khoản của tôi<!-- --> </a>
<div class="menu-spacer___3Gp4L"></div>
<a href="/vn/wishlist">danh sách yêu thích<!-- --> </a>
<div class="menu-spacer___3Gp4L"></div>
<a href="#">trạng thái đơn hàng<!-- --> </a>
<em><a class="selfservice-link-login" href="/vn/login/login_success.php" title="Tài Khoản Của Tôi <?php echo $_SESSION["name"];?>">Chào mừng trở lại <?php echo $_SESSION["name"];?>
<span class="login-icon"></span></a></em>
</div>

<div id="logo"><a href="/"><img src="/img/logo.png" style="float: left; position: absolute; margin-left: 65px;"></a></div>
<img src="/img/header-shadow-img.png" style="vertical-align: middle;width: 100%; max-height: 30px;" >
<!-- ---------------------------------------------------------------------------------------------------------------------------- -->
<div class="menu">
<ul>
<li class="dropdown">
...
<li class="dropdown">
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 1 -->
            <a style="text-decoration: none"><h2>NỔI BẬT</h2></a>
            <a href="/vn/?women-new-arrivals">Hàng Mới Về</a>
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 3 -->
            ...
            <a href="/vn/?kids-new-arrivals">Hàng Mới Về</a>
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 4 -->
            ...
            <a href="/vn/?running"><img src="/img/running.png"></a>
            <br>
          ...
          <div class="col"> <!-- cột 2 menu 1 -->
            ...
            <a href="/vn/?soccer"><img src="/img/FB_SS18_DeadlyStrike_Predator_NV-IMG.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 3 menu 1 -->
            ...
            <a href="/vn/?basketball"><img src="/img/new_harden_basketball_flyout_nav.jpg" height="80" width="172"></a>
            <br>
          ...
          <div class="col"> <!-- cột 4 menu 1 -->
            ...
            <a href="/vn/?football"><img src="/img/CLP_nav_1.jpg"></a>
            <br>
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 5 -->
            <a href="/vn/?originals"><img src="/img/text_originals.png"></a>
            <br>
            <a href="/vn/?originals"><img src="/img/D1_websine_nav_172x80.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 2 menu 5 -->
            <a href="/vn/?athletics-zne"><img src="/img/adidas-logo-menu-2.jpg"></a>
            <br>
            <a href="/vn/?athletics-zne"><img src="/img/Athletics_Flyout_US.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 3 menu 5 -->
            <a href="/vn/?adidas_by_stella_mccartney"><img src="/img/SM.png"></a>
            <br>
            <a href="/vn/?adidas_by_stella_mccartney"><img src="/img/aSMC_SS18_Run_SUP_03_Flyout_Nav_172x80.jpg"></a>
            <br>
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 6 -->
            ...
            <a href="/vn/?originals-customizable"><img src="/img/mi_1.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 2 menu 6 -->
            ...
            <a href="/vn/?running-customizable"><img src="/img/ss18_miultraboost_multicolor_Topnav.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 3 menu 6 -->
            ...
            <a href="/vn/?basketball-customizable"><img src="/img/mi_3.jpg"></a>
            <br>
...
<a title="Kiểm tra" href="<?php if(empty ($_SESSION["email"])) echo '/vn/login/'; else echo '/vn/cart';?>" class="addtobag"><img src="/img/bag.png" style="float: right"></a>

<div class="wish" <?php if(empty ($total_records)) echo ' style="display: none"';?>>
  <a href="<?php if(empty ($_SESSION["email"])) echo '/vn/login/'; else echo '/vn/wishlist';?>" class="addtobag">
  <img src="/img/wish.png" style="float: right">
  <div class="centered">
