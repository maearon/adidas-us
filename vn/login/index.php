...
<img class="button-image" src="/static/login/facebook.svg" alt="Facebook" />
...
<img class="button-image" src="/static/login/google.svg" alt="Google" />
...
<div class="col-6 right logincreate block logincustomers-wrapper ssojs">
    ...
    <a href="/vn/register" class="materialize-btn materialize-btn-black" type="submit" value="Đăng ký" name="dwfrm_createaccount_register"><span>Đăng ký</span></a>
    </div>
</div>
