	...
	<div class="styled_nav universe_link ">
		<div class="contentasset" data-contentasset-id="account-navigation" data-contentasset="account-navigation">
			<ul class="adi-myaccout-redesign">
				<li class="navgroup"><a class="nav-title universe_link account_overview_link" title="Tài Khoản Của Tôi" href="/vn/login/login_success.php">Tài Khoản Của Tôi</a></li>
				<li class="navgroup"><a class="nav-title personal_information_link" title="Personal Information" href="/vn/login/profile.php">Thông Tin Cá Nhân</a></li>
				<li class="navgroup"><a class="nav-title your_preferences_link" title="Your Preferences" href="#">Tùy Chọn Của Bạn</a></li>
				<li class="navgroup"><a class="nav-title address_book_link" title="Address Book" href="/vn/login/address.php">Địa Chỉ Đặt Trước</a></li>
...
<div class="accountcenter">
	<div class="accountwelcome">
		...
		<div class="not_user">
			Không phải <span class="username"><?php echo $_SESSION["name"];?>?</span> <a title="Đăng xuất" href="/vn/login/logout.php">Đăng xuất</a>
		</div>
	</div>
